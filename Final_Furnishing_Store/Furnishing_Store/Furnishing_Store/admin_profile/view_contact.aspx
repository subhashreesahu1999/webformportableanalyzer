<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_contact.aspx.cs" Inherits="Furnishing_Store.admin_profile.view_contact" %>
              ...
              <!--View-->
                    ...
                    <div class="container">
                        <div class="card " runat="server" id="orders" Visible="true">
                          <div class="card-body ">
                            <h5 class="card-title text-center">Total Contact Messages : <asp:Label ID="contactmsg" runat="server" Text=""></asp:Label></h5>
                              <hr>
                                </div>
                            <div class="text-center p-5">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting" DataSourceID="SqlDataSource1">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Furnishing_StoreConnectionString %>" DeleteCommand="DELETE FROM [contact] WHERE [id] = @id" InsertCommand="INSERT INTO [contact] ([name], [email], [phone], [message], [time]) VALUES (@name, @email, @phone, @message, @time)" SelectCommand="SELECT [id], [name], [email], [phone], [message], [time] FROM [contact]" UpdateCommand="UPDATE [contact] SET [name] = @name, [email] = @email, [phone] = @phone, [message] = @message, [time] = @time WHERE [id] = @id">
                                    <DeleteParameters>
