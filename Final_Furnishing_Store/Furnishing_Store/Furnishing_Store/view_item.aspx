<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_item.aspx.cs" Inherits="Furnishing_Store.view_item" %>
            ...
            <!--navbar-->
                <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light nav-a">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="product.aspx"><span class="nav-word" style="color:red"><u>Product-Item</u></span></a>
                        </li>
                        <li class="nav-item">
                       ...
                       <!-- <a class="nav-item m-1">
                        <Span class="top" data-toggle="modal" data-target="#ModalCenter">Checkout</Span>
                        </a>-->
                        

                        <a class="nav-item m-1" href="login.aspx">
                            <button class="btn btn-outline-success my-2 my-sm-0" type="submit" runat="server">Login</button>
                        </a>
                ...
                <ItemTemplate>
                    ...
                    <br><br><br>
                        <div class="row">
                            <div class="col-sm-6">
                            <br>
                            <h3>OSMAR Dining Table 120x80 BK/NT</h3>
                            <br>
                            ...
                            <br><br><br><br>
                                ...
                                <p class="ml-5 details">ID: <%# Eval("product_id")%></p>
                                <p class="ml-5 details">Price: Rs <%#Eval("price") %></p>
                                <p class="ml-5 "><small  class="details text-muted">Price is inclusive of VAT</small></p>
                                   ...
                                   Quantity: <asp:DropDownList ID="DropDownList1" runat="server">
                                    ...
                                    <div class="text-center container-card-button">
                                        ...
                                        <asp:Button ID="btnAddToCart"  class="btn btn-default" Text="ADD TO CART" data-toggle="modal" data-target="#Modal"/>
